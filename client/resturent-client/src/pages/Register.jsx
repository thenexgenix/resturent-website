  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row">
      ...
      <div className="w-full md:w-1/2 flex items-center justify-center p-6 md:p-16">
        ...
        >
          <motion.h1
            className="text-4xl font-extrabold text-[#F90806] mb-4 text-center"
          ...
          >
            ...
            >
              ...
              <label className="text-sm text-gray-700">
                I agree to the{" "}
                <Link to="/terms" className="text-[#F90806] underline italic">
      ...
      >
        <motion.div
          className="absolute inset-0 bg-[#0000008f]  flex flex-col items-center justify-center text-center p-8"
          initial="hidden"
          animate="visible"
        ...
        >
          ...
          <p className="text-white text-lg">
            Create your account to access exclusive features and start exploring.
          </p>
        </motion.div>
      </div>
    </div>
